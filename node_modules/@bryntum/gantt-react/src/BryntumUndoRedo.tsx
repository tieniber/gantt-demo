...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, ProjectModelConfig, Rectangle, SchedulerProjectModel, Scroller, ScrollerConfig, TabConfig, TooltipConfig, UndoRedo, UndoRedoListeners, Widget } from '@bryntum/gantt';
...
export type BryntumUndoRedoProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/UndoRedo#config-ariaLive)
     */
    ariaLive? : string
    /**
