...
export type BryntumTabPanelProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/TabPanel#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {Widget} event.activeItem The new active child widget.
     * @param {number} event.prevActiveIndex The previous active index.
     * @param {Widget} event.prevActiveItem The previous active child widget.
     */
