...
export type BryntumGanttBaseProps = {
     ...
     * @param {TaskModel} event.taskRecord Task record being resized
     ...
     * is named using [generateNewName](https://bryntum.com/products/gantt/docs/api/Gantt/feature/TaskCopyPaste#config-generateNewName)
     * ...
