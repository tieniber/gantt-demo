...
import { AlignSpec, Base, DomConfig, KeyMapConfig, Label, LabelListeners, MaskConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumLabelProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Label#config-ariaLive)
     */
    ariaLive? : string
    /**
