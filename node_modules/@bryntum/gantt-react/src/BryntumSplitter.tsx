...
import { AlignSpec, Base, DomConfig, KeyMapConfig, MaskConfig, Rectangle, Scroller, ScrollerConfig, Splitter, SplitterListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumSplitterProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Splitter#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {object} event Event object
     * @param {Splitter} event.source The Splitter
