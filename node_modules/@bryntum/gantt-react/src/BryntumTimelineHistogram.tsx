...
export type BryntumTimelineHistogramProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ariaLive)
     */
    ariaLive? : string
    /**
