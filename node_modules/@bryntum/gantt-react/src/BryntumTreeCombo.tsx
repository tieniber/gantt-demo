...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, Scroller, Store, StoreConfig, TabConfig, TooltipConfig, TreeCombo, TreeComboListeners, Widget } from '@bryntum/gantt';
...
export type BryntumTreeComboProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/TreeCombo#config-ariaLive)
     */
    ariaLive? : string
    /**
