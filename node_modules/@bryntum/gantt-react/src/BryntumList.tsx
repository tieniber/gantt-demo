...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, KeyMapConfig, List, ListListeners, MaskConfig, Model, ModelConfig, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumListProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-ariaLive)
     */
    ariaLive? : string
    /**
