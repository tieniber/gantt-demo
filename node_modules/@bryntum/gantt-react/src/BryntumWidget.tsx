...
import { AlignSpec, Base, DomConfig, KeyMapConfig, MaskConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget, WidgetListeners } from '@bryntum/gantt';
...
export type BryntumWidgetProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-ariaLive)
     */
    ariaLive? : string
    /**
