...
import { AlignSpec, Base, CollectionFilter, CollectionFilterConfig, ComboConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FieldFilterPicker, FieldOption, Grid, GridFieldFilterPicker, GridFieldFilterPickerListeners, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, ValueFieldPlaceholders, Widget } from '@bryntum/gantt';
...
export type BryntumGridFieldFilterPickerProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {object} event Event object
     * @param {FieldFilterPicker} event.source The FieldFilterPicker instance that fired the event.
