...
import { AlignSpec, Base, Checkbox, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, Scroller, SlideToggle, SlideToggleListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumSlideToggleProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/SlideToggle#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/SlideToggle#config-editable)
     */
    editable? : boolean
    extraData? : any
    /**
     ...
     * @param {Checkbox} event.source Checkbox
     ...
     */
    onBeforeChange? : ((event: { source: Checkbox, checked: boolean }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Checkbox} event.source The checkbox
