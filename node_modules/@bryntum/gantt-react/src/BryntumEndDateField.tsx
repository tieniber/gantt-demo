...
import { AlignSpec, Base, ContainerItemConfig, DatePickerConfig, DomConfig, DurationConfig, EndDateField, EndDateFieldListeners, EventModel, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, SchedulerProProjectModel, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumEndDateFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/EndDateField#config-ariaLive)
     */
    ariaLive? : string
    /**
