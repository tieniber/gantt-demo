...
import { AlignSpec, Base, ColorDescriptor, ContainerItemConfig, DomConfig, EventColorField, EventColorFieldListeners, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumEventColorFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/EventColorField#config-ariaLive)
     */
    ariaLive? : string
    /**
