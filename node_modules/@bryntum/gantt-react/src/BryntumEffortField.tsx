...
import { AlignSpec, Base, ContainerItemConfig, DomConfig, Duration, DurationConfig, DurationField, DurationUnit, EffortField, EffortFieldListeners, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumEffortFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/EffortField#config-ariaLive)
     */
    ariaLive? : string
    /**
