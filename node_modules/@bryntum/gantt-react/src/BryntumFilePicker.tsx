...
import { AlignSpec, Base, ButtonConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FileFieldConfig, FilePicker, FilePickerListeners, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumFilePickerProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilePicker#config-ariaLive)
     */
    ariaLive? : string
    /**
