...
import { AlignSpec, Base, CalendarEditorConfig, CalendarField, CalendarFieldListeners, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ContainerItemConfig, DomConfig, EventModel, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, SchedulerProCalendarManagerStore, SchedulerProProjectModel, SchedulerProResourceModel, Scroller, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumCalendarFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/CalendarField#config-ariaLive)
     */
    ariaLive? : string
    /**
