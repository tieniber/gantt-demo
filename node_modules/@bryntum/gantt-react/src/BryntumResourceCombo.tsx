...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, ResourceCombo, ResourceComboListeners, Scroller, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumResourceComboProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceCombo#config-ariaLive)
     */
    ariaLive? : string
    /**
