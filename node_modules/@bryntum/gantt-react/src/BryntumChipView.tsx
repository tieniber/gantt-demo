...
import { AlignSpec, Base, ChipView, ChipViewListeners, Collection, CollectionConfig, DomConfig, KeyMapConfig, List, MaskConfig, Model, ModelConfig, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumChipViewProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/ChipView#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * function returning the value of the record´s [displayField](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-displayField)
     * @param {Model} record The record
     * @returns {string}
     */
     ...
     */
    onBeforeItem? : ((event: { source: List, record: Model, args: number, event: Event }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Model} event.record The parent record which has been toggled
     * @param {boolean} event.collapse Collapsed (true) or expanded (false)
     */
