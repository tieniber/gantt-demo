...
export type BryntumVersionGridProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/VersionGrid#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {object} event Event object
     * @param {VersionModel} event.version The [VersionModel](https://bryntum.com/products/gantt/docs/api/SchedulerPro/model/VersionModel) being restored
     */
