...
import { AlignSpec, Base, ColorDescriptor, ColorField, ColorFieldListeners, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumColorFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/ColorField#config-ariaLive)
     */
    ariaLive? : string
    /**
