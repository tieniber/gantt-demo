...
import { AlignSpec, Base, ContainerItemConfig, DateFieldConfig, DateTimeField, DateTimeFieldListeners, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, TabConfig, TimeFieldConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumDateTimeFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/DateTimeField#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/DateTimeField#config-tabIndex)
     */
    tabIndex? : number
    /**
     ...
     */
    onAction? : ((event: { source: Field|any, value: string|number|boolean|any, oldValue: string|number|boolean|any, valid: boolean, event: Event, record: Model, records: Model[], userAction: boolean }) => void)|string
    /**
     ...
     * @param {boolean} event.userAction Triggered by user taking an action (`true`) or by setting a value (`false`)
     */
    onChange? : ((event: { source: Field|any, value: string|number|boolean|any, oldValue: string|number|boolean|any, valid: boolean, event: Event, userAction: boolean }) => void)|string
    /**
