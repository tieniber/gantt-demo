...
export type BryntumFieldFilterPickerGroupProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FieldFilterPickerGroup#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {object} event Event object
     * @param {FieldFilterPickerGroup} event.source The FieldFilterPickerGroup instance that fired the event.
