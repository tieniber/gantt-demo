...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, Editor, EditorListeners, InputFieldConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumEditorProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     * @param {Editor} event.source The Editor that triggered the event.
     */
     ...
     * @param {Model} event.record The record being edited.
