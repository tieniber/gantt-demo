...
import { AlignSpec, Base, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, NumberField, NumberFieldListeners, NumberFormatConfig, Rectangle, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumNumberFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/NumberField#config-ariaLive)
     */
    ariaLive? : string
    /**
