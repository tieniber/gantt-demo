...
export type BryntumDateRangeFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/DateRangeField#config-ariaLive)
     */
    ariaLive? : string
    /**
