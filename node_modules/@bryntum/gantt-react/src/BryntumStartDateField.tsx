...
import { AlignSpec, Base, ContainerItemConfig, DatePickerConfig, DomConfig, DurationConfig, EventModel, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, SchedulerProProjectModel, Scroller, StartDateField, StartDateFieldListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumStartDateFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/StartDateField#config-ariaLive)
     */
    ariaLive? : string
    /**
