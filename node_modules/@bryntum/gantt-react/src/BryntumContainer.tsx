...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, ContainerListeners, DomConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumContainerProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Container#config-ariaLive)
     */
    ariaLive? : string
    /**
