...
import { AlignSpec, Base, ContainerItemConfig, DomConfig, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, TabConfig, TimeField, TimeFieldListeners, TooltipConfig, Widget, WidgetConfig } from '@bryntum/gantt';
...
export type BryntumTimeFieldProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/TimeField#config-ariaLive)
     */
    ariaLive? : string
    /**
