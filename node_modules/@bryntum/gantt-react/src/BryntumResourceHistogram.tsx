...
export type BryntumResourceHistogramProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/ResourceHistogram#config-ariaLive)
     */
    ariaLive? : string
    /**
     ...
     */
    barTooltipTemplate? : (context: { datum: ResourceAllocationInterval, tip: Tooltip, element: HTMLElement, activeTarget: HTMLElement, event: Event }, data: { record: SchedulerProResourceModel }) => string
    /**
