...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, GroupBar, GroupBarListeners, KeyMapConfig, List, MaskConfig, Model, ModelConfig, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumGroupBarProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ariaLive)
     */
    ariaLive? : string
    /**
