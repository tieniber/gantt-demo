...
import { AjaxStore, AlignSpec, Base, ClickRepeaterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, PagingToolbar, PagingToolbarListeners, Rectangle, Scroller, ScrollerConfig, TabConfig, Tool, ToolConfig, ToolbarItems, TooltipConfig, Widget } from '@bryntum/gantt';
...
export type BryntumPagingToolbarProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/PagingToolbar#config-ariaLive)
     */
    ariaLive? : string
    /**
    ...
    /**
     * The [AjaxStore](https://bryntum.com/products/gantt/docs/api/Core/data/AjaxStore) that this PagingToolbar is to control.
     */
    store? : AjaxStore
    /**
